...
Для добавления кнопок в меню необходимо добавить запись в таблицу [Button](#таблица-button). Затем необходимо связать id_menu (см. [Menu](#таблица-menu)) и id_button (см. [Button](#таблица-button)) посредством добавления записи в таблицу [List_Buttons](#таблица-list_buttons).
...
Для того чтобы при нажатии на кнопку выполнялся переход в соответствующее меню необходимо добавить запись в таблицу [List_Void_Menu](#таблица-list_void_menu) с требуемыми id_menu (см. [Menu](#таблица-menu)) и id_button (см. [Button](#таблица-button)).
...
Таблица [Information](#таблица-information) содержит различную информацию (см. [Type_Information](#таблица-type_information)). Для того чтобы задать тип добавленной информации необходимо добавить запись в таблицу [List_Information](#таблица-list_information) с соответствующими id_information (см. [Information](#таблица-information)) и id_type_infromation (см. [Type_Information](#таблица-type_information)).
...
Добавление информации о пользователе в таблицу [User](#таблица-user) выполняется автоматически при регистрации пользователя или добавлением записи в базу данных. Для задания категории пользователя необходимо иметь права администратора (см. [панель администратора](#панель-администратора)), изначально все зарегистрированные пользователи имеют категорию "Пользователь". Информация о категории пользователя содержится в таблице [List_Users](#таблица-list_users).
...
Информация об анекдотах находится в таблице [Anecdote](#таблица-anecdote), добавление анекдотов сводится добавлением записи в эту таблицу.
...
Таблица [Event](#таблица-event) содержит информацию о возможных событиях при нажатии кнопки (см. [Button](#таблица-button)).
...
Таблица [Template](#таблица-template) содержит информацию о шаблоне меню (см. [Menu](#таблица-menu)).
...
Таблица [Type_Information](#таблица-type_information) содержит информацию о типе информации (см. [Information](#таблица-information)). Типы "Изображение" и "Файл" представляют собой информацию о пути к файлам .jpg и .doc.
...
Таблица [Type_Menu](#таблица-type_menu) содержит информацию о типе меню (см. [Menu](#таблица-menu)). Тип "Reply" представляет собой начальное меню, тип "Inline" - меню в виде сообщений.
...
Таблица [Category_Users](#таблица-category_users) содержит категории пользователей (см. [встроенные команды бота](#встроенные-команды-бота) и [панель администратора](#панель-администратора)).
