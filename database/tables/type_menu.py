...
"""! @brief Пакет содержащий класс TypeMenu."""

from .table import Table
from .data_for_tables.data_type_menu import type_menu_data as data
from .query_for_tables.query_type_menu import query_create, query_insert

class TypeMenu(Table):
    """! Класс-таблица TypeMenu
    """    
