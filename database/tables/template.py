...
"""! @brief Пакет содержащий класс Template."""

from .table import Table
from .data_for_tables.data_template import template_data as data
from .query_for_tables.query_template import query_create, query_insert
